...
Im Mathe-Modus ist es ein Unterschied, ob die Maßzahl vor dem \tex{unit}-Befehl steht,
...
Um eine einheitliche Darstellung der Zahlen zu erreichen, kann man den Befehl \tex{digits} verwenden.
...
Der \tex{spaceedigits} Befehl fügt den Zwischenraum automatisch ein.
Damit hier ein \type{,} als Dezimaltrenner erscheint,
muss das \tex{spaceddigitssymbol} entsprechend definiert werden.

Mit diesem Befehl kann man sich ein eigenen \tex{spacedunit} Befehl definieren.
