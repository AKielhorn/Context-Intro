...
Alternativ gibt es auch eine Form in der der Text als Argument übergeben wird, diese Version ist zu bevorzugen.
...
\setupalign[tolerant]
\item
  hervorgehoben: \type{{\em }} {\em hervorgehoben} oder \type{\emph{hervorgehoben}} \emph{hervorgehoben}. 
...
\startitemize
\item \start\setupbodyfont[antykwa-poltawskiego]Antykwa-Poltawskiego\stop
\item \start\setupbodyfont[antykwa]Antykwa Toruńska\stop
...
\starttyping
\start\setupbodyfont[antykwa-poltawskiego]Antykwa-Poltawskiego\stop
\start\setupbodyfont[antykwa]Antykwa Toruńska\stop
