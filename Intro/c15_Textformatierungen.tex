...
\item
  ...
  (Achtung: Es gibt noch den alten Befehl \type{\os}, dieser sollte {\em nicht} mehr verwendet werden.
  \type{\os}: {\os 1992 -- 1999} \type{\oldstyle}: {\oldstyle 2000 -- 2020})
\item
  Durchstreichen: \type{\overstrike{}} {\overstrike{over}}, 
  für einen durchgehenden Strich und \type{\overstrikes} für einen Strich pro Wort.
...
Analog gibt es auch die Befehle \type{\overbar}, \type{\overbars} sowie \type{\underbar} und \type{\underbars}.
...
Dann lässt sich mit \type{\Highlight{}} der Text \Highlight{auch über mehrere Wörter markieren.}
