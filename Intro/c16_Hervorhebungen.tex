...
Mit dem Befehl \tex{startnarrower} wird der Rand standardmäßig auf beiden Seiten um \unit{5 mm} verbreitert,
...
Die Option \type{[middle]} muss beim \tex{startnarrower}-Befehl nicht angegeben werden,
