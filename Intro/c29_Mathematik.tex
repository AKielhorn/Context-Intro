...
Dies muss als \type{\mathtext{}} eingegeben werden.
...
In der \type{\mathword} Variante werden Leerzeichen ignoriert.
Das ist hilfreich, wenn der Text automatisch erzeugt wird.

\starttabulate [|l|l|]
\NC \type{\mathtext{Aufrechter Text}}        \NC $\mathtext{Aufrechter Text}$        \NC \NR
\NC \type{\mathtexttf{Aufrechter Text}}      \NC $\mathtexttf{Aufrechter Text}$      \NC \NR
\NC \type{\mathtextit{Kursiver Text}}        \NC $\mathtextit{Kursiver Text}$        \NC \NR
\NC \type{\mathtextsl{Schräger Text}}        \NC $\mathtextsl{Schräger Text}$        \NC \NR
\NC \type{\mathtextbf{Fetter Text}}          \NC $\mathtextbf{Fetter Text}$          \NC \NR
\NC \type{\mathtextbi{Fetter kursiver Text}} \NC $\mathtextbi{Fetter kursiver Text}$ \NC \NR
\NC \type{\mathtextbs{Fetter schräger Text}} \NC $\mathtextbs{Fetter schräger Text}$ \NC \NR
\stoptabulate

\starttabulate [|l|l|]
\NC \type{\mathword{Aufrechtes Wort}}        \NC $\mathword{Aufrechtes Wort}$        \NC \NR
\NC \type{\mathwordtf{Aufrechtes Wort}}      \NC $\mathwordtf{Aufrechtes Wort}$      \NC \NR
\NC \type{\mathwordit{Kursives Wort}}        \NC $\mathwordit{Kursives Wort}$        \NC \NR
\NC \type{\mathwordsl{Schräges Wort}}        \NC $\mathwordsl{Schräges Wort}$        \NC \NR
\NC \type{\mathwordbf{Fettes Wort}}          \NC $\mathwordbf{Fettes Wort}$          \NC \NR
\NC \type{\mathwordbi{Fettes kursives Wort}} \NC $\mathwordbi{Fettes kursives Wort}$ \NC \NR
\NC \type{\mathwordbs{Fettes schräges Wort}} \NC $\mathwordbs{Fettes schräges Wort}$ \NC \NR
\stoptabulate
...
In LMTX gibt es daher den neuen Befehl \type{\TC} für TextColumn. 
Ein \type{\NC} erzeugt jetzt eine Spalte im Mathe-Modus.
