...
\type{$P_{\mathtext{Antrieb}}$} $P_{\mathtext{Antrieb}}$ statt \type{$P_{Antrieb}$} $P_{Antrieb}$.
...
\starttabulate [|l|l|]
\NC \tex{mathtext{Aufrechter Text}}        \NC $\mathtext{Aufrechter Text}$        \NC \NR
\NC \tex{mathtexttf{Aufrechter Text}}      \NC $\mathtexttf{Aufrechter Text}$      \NC \NR
\NC \tex{mathtextit{Kursiver Text}}        \NC $\mathtextit{Kursiver Text}$        \NC \NR
\NC \tex{mathtextsl{Schräger Text}}        \NC $\mathtextsl{Schräger Text}$        \NC \NR
\NC \tex{mathtextbf{Fetter Text}}          \NC $\mathtextbf{Fetter Text}$          \NC \NR
\NC \tex{mathtextbi{Fetter kursiver Text}} \NC $\mathtextbi{Fetter kursiver Text}$ \NC \NR
\NC \tex{mathtextbs{Fetter schräger Text}} \NC $\mathtextbs{Fetter schräger Text}$ \NC \NR
\stoptabulate

\starttabulate [|l|l|]
\NC \tex{mathword{Aufrechtes Wort}}        \NC $\mathword{Aufrechtes Wort}$        \NC \NR
\NC \tex{mathwordtf{Aufrechtes Wort}}      \NC $\mathwordtf{Aufrechtes Wort}$      \NC \NR
\NC \tex{mathwordit{Kursives Wort}}        \NC $\mathwordit{Kursives Wort}$        \NC \NR
\NC \tex{mathwordsl{Schräges Wort}}        \NC $\mathwordsl{Schräges Wort}$        \NC \NR
\NC \tex{mathwordbf{Fettes Wort}}          \NC $\mathwordbf{Fettes Wort}$          \NC \NR
\NC \tex{mathwordbi{Fettes kursives Wort}} \NC $\mathwordbi{Fettes kursives Wort}$ \NC \NR
\NC \tex{mathwordbs{Fettes schräges Wort}} \NC $\mathwordbs{Fettes schräges Wort}$ \NC \NR
\stoptabulate
