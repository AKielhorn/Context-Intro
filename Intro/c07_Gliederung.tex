...
ConTeXt versteht die Befehle \tex{chapter{}}, \tex{section{}} usw. um einen neuen Abschnitt einzuleiten.
  
Für einige Funktionen (tagged-PDF, ePUB Export und XML Export) muss die Gliederung als Umgebung definiert werden.
Diese Version sollte bevorzugt verwendet werden, da sie zusätzliche Optionen bietet:
  
\starttyping
  \startsection[
    title={Gliederung},
    reference=gliederung,  % Für Verweise auf dieses Kapitel
    bookmark={Gliederung}, % Bookmark für PDF
    ]
    Lorem ipsum dolor
  \stopsection
\stoptyping
  ...
  \startsubsection[
    ...
    \startsubsubsection[
      ...
      \startsubsubsubsection[
        ...
        Das läßt sich jedoch leicht mit dem Befehl \tex{setuphead[subsubsubsection][number=yes]} ändern.
