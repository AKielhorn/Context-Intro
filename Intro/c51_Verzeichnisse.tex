...
Das Inhaltsverzeichnis wird entweder mit \tex{completecontent[criterium=all]}
oder mit \tex{placecontent[criterium=all]} erstellt. 
...
Jetzt steht der Befehl \tex{myregister}\myregister{Myregister} zur Verfügung.
Das Verzeichnis wird mit \tex{placemyregister} ausgegebn.
