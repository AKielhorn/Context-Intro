...
\index{Chemie}
Zur Eingabe chemischer Formeln benutzt man den \tex{chemical} Befehl.
...
Außerhalb der \type{startchemical} Umgebung funktioniert der \tex{chemical} Befehl nicht,
wenn PDF/A erzeugt werden soll.
Der \tex{molecule} Befehl liefert aber die einzelnen Moleküle auch im Text: 
\molecule{2 H_2} + \molecule{O_2} \rightarrow \molecule{2 H_2O}.
