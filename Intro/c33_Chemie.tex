...
Außerhalb der \type{startchemical} Umgebung funktioniert der \type{\chemical} Befehl nicht,
wenn PDF/A erzeugt werden soll.
Der \type{\molecule} Befehl liefert aber die einzelnen Moleküle auch im Text: 
