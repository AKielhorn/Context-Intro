...
\goto{SciTE}[url(https://www.scintilla.org)] läuft unter Windows und Linux.
Für MacOS gibt es eine kommerzielle Version, 
\goto{Textadept}[url(https://foicica.com/textadept/)] gibt es auch für andere Betriebssysteme.

\type{TeXShop} bietet keine spezielle Syntaxhervorhebung für ConTeXt, markiert aber alle Befehle.
Es werden Definitionen zum Aufruf von ConTeXt mitgeliefert und \type{TeXShop} unterstützt auch SyncTeX, Damit kann man zwischen Quelltext und PDF hin- und herspringen.

Programme wie \type{TeXworks} und \type{TeXstudio} bieten nur eine Unterstützung für LaTeX,
